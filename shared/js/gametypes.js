...
var kinds = {
    ...
    rat: [Types.Entities.RAT, "mob", 50, 2],
    skeleton: [Types.Entities.SKELETON , "mob", 150, 8],
    goblin: [Types.Entities.GOBLIN, "mob", 100, 5],
    ogre: [Types.Entities.OGRE, "mob", 250, 12],
    spectre: [Types.Entities.SPECTRE, "mob", 400, 21],
    deathknight: [Types.Entities.DEATHKNIGHT, "mob", 500, 24],
    yellowbat: [Types.Entities.YELLOWBAT, "mob", 650, 4],
    spider: [Types.Entities.SPIDER, "mob", 300, 12],
    fluffy: [Types.Entities.FLUFFY, "mob", 325, 8],

    bee: [Types.Entities.BEE, "mob", 250, 6],
    crab: [Types.Entities.CRAB, "mob", 50, 1],
    snake: [Types.Entities.SNAKE, "mob", 350, 10],
    bat: [Types.Entities.BAT, "mob", 100, 3,],
    wizard: [Types.Entities.WIZARD, "mob", 300, 1],
    eye: [Types.Entities.EYE, "mob", 650, 18],
    skeleton2: [Types.Entities.SKELETON2, "mob", 650, 15],
    boss: [Types.Entities.BOSS, "mob", 1000,  48],
    ...
    powersword: [Types.Entities.POWERSWORD, "weapon"],
    ...
    powerarmour: [Types.Entities.POWERARMOUR, "armor"],
