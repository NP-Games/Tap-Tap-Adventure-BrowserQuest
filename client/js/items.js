    ...
    var Items = {
        ...
        GoldenSword: Item.extend({
            init: function(id) {
                ...
                this.lootMessage = "You pick up the golden sword";
            },
        }),
        
        PowerSword: Item.extend({
            init: function(id) {
                this._super(id, Types.Entities.POWERSWORD, "weapon");
                this.lootMessage = "You pick up the power sword";
            },
        }),
        ...
        PowerArmour: Item.extend({
            init: function(id) {
                this._super(id, Types.Entities.POWERARMOUR, "armor");
                this.lootMessage = "You equip a power armor";
            },
        }),
        ...
        FirePotion: Item.extend({
            init: function(id) {
                ...
                this.lootMessage = "You feel the strength of Firefox!";
            },
