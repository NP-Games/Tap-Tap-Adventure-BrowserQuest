...
define(['mobs', 'items', 'npcs', 'warrior', 'chest'], function(Mobs, Items, NPCs, Warrior, Chest) {
    ...
    EntityFactory.builders[Types.Entities.POWERSWORD] = function(id) {
        return new Items.PowerSword(id);
    };
    ...
    EntityFactory.builders[Types.Entities.POWERARMOUR] = function(id) {
        return new Items.PowerArmour(id);
    };
